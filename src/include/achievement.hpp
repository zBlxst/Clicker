...
public:
    ...
    static constexpr int N_ACHIEVEMENTS = N_MONEY_ACHIEVEMENTS 
                                        + N_MONEY_CLICK_ACHIEVEMENTS
                                        + N_CLICK_ACHIEVEMENTS
                                        + N_BUILDING_ACHIEVEMENTS * Building::N_BUILDINGS;
...
private:
    ...
    static constexpr double CLICK_ACHIEVEMENTS[N_CLICK_ACHIEVEMENTS] = {100, 500, 1000, 2500, 5000, 10000, 20000, 50000, 100000};
