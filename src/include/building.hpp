...
public:
    ...
    static constexpr double UPGRADE_BUFFS[N_UPGRADES] = {100, 200, 300, 400, 500, 400, 300, 200, 100, 200, 300, 400, 500, 400, 300, 400, 500, 400, 300};
    static constexpr double UPGRADE_COSTS[N_BUILDINGS][N_UPGRADES] = {
